...
class MyWorker(context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
	...
	companion object {
		...
		const val APP_ID = "2b605906c2035877498f5fdc4106f3ba"
...
//	Class Worker merupakan kelas abstrak sehingga methodnya harus dioverride

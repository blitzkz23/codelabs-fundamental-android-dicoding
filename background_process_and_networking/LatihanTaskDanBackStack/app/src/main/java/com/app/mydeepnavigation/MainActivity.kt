...
//		Add backstack by using TaskStackBuilder so if the user open notification it will lead to detail activity and if user press back it return to main activity, not exit the app.
